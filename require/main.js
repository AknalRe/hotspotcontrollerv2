...
const { APP_ENV, APP_PORT, APP_NAME, APP_TITLE, APP_AUTHOR, MK_HOST, MK_PORT, MK_USER, MK_PASS, MK_TIMEOUT, WAHA_URL, WAHA_KEY, WAHA_SESSION, ID_GRUP_NOTIF, ID_GRUP_SPAM, PROFILE_DEFAULT_TAMU, PARAM_USERTAMBAH, URL_HOTSPOT, WEBHOOKN8N } = process.env;
