...
const { APP_ENV, APP_PORT, APP_NAME, APP_TITLE, APP_AUTHOR, MK_HOST, MK_PORT, MK_USER, MK_PASS, MK_TIMEOUT, LINKWA, LINKWA2, APIKEYWA, APIKEYWA2, IDKOMUNITAS, IDGRUPINFOSPAM, PROFILE_DEFAULT_TAMU, PARAM_USERTAMBAH, URL_HOTSPOT } = process.env;
